...
import { ArrowLeftIcon, TagIcon, CalendarIcon, CurrencyDollarIcon } from '@heroicons/react/24/outline';
...
export default function MembershipTypesCreate() {
    ...
    const handleDurationTypeChange = (e) => {
        ...
        setData(prev => ({ ...prev, duration_type: type, duration_days: days }));
    };
    ...
    return (
        <AuthenticatedLayout title="Tambah Jenis Member">
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Jenis Membership Baru</h2>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Tambahkan jenis membership baru untuk member</p>
                    </div>
                    ...
                    <form onSubmit={submit} className="p-6 space-y-6">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="text" value={data.name} onChange={(e) => setData('name', e.target.value)} className={`${inputClass} pl-10`} placeholder="Contoh: Bulanan - Gold" />
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select value={data.duration_type} onChange={handleDurationTypeChange} className={inputClass}>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="number" value={data.price} onChange={(e) => setData('price', parseFloat(e.target.value))} className={`${inputClass} pl-12`} min="0" placeholder="0" />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 font-medium">Rp</span>
                                    <input type="number" value={data.renewal_price} onChange={(e) => setData('renewal_price', parseFloat(e.target.value))} className={`${inputClass} pl-12`} min="0" placeholder="0" />
                                </div>
                        ...
                        <div>
                            ...
                            <textarea value={data.description} onChange={(e) => setData('description', e.target.value)} className={`${inputClass} resize-none`} rows="3" placeholder="Deskripsi singkat tentang jenis membership ini..." />
                        </div>
