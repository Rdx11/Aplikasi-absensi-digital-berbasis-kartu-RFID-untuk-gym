...
export default function DailyPackagesCreate() {
    ...
    return (
        <AuthenticatedLayout title="Tambah Paket Harian">
            <Head title="Tambah Paket Harian" />
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 mb-6">
                    ...
                    <div className="p-6 space-y-5">
                        <div>
                            ...
                            <input type="text" value={data.name} onChange={(e) => setData('name', e.target.value)} className={inputClass} placeholder="Contoh: Paket Pagi" />
                            {errors.name && <p className="text-red-500 text-sm mt-1">{errors.name}</p>}
                        </div>

                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Deskripsi</label>
                            <textarea value={data.description} onChange={(e) => setData('description', e.target.value)} className={`${inputClass} resize-y`} rows="3" placeholder="Deskripsi paket (opsional)" />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" value={data.price} onChange={(e) => setData('price', e.target.value)} className={inputClass} placeholder="50000" />
